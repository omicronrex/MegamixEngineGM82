...
var msg; msg = "";
var warningLevel; warningLevel = WL_VERBOSE;
var col; col = c_white;
var noConsole; noConsole = false;
if (argument_count > 0)
...
// split lines:
var MAX_LINE_WIDTH; MAX_LINE_WIDTH = 32;
var MIN_LINE_WIDTH; MIN_LINE_WIDTH = 16;
if (string_length(msg) > MAX_LINE_WIDTH)
{
    // finds last space:
    var last_space; last_space = min(string_length(msg), MAX_LINE_WIDTH) - stringIndexOf(stringReverse(stringSubstring(msg, 0, MAX_LINE_WIDTH)), " ") + 1;
    if (last_space <= 4)
        last_space = MAX_LINE_WIDTH;
    var newline; newline = stringIndexOf(msg, "
    ");
