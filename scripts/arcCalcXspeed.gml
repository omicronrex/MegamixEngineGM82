...
var t_yspeed; t_yspeed = argument[0];
var t_grav; t_grav = argument[1];
var t_spawn_x; t_spawn_x = argument[2];
var t_spawn_y; t_spawn_y = argument[3];
var t_impact_x; t_impact_x = argument[4];
var t_impact_y; t_impact_y = argument[5];
var t_speed_limit; t_speed_limit = 8;
if (argument_count > 6)
{
